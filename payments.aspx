<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="payments.aspx.cs" Inherits="payments" %>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <asp:GridView CssClass="table table-responsive"  ID="gvdebts" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="trans_id" DataSourceID="dsDebtors" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvdebts_SelectedIndexChanged">
                                ...
                                <Columns>
                                    <asp:CommandField ShowSelectButton="True" SelectText="Mark Paid" />
                            ...
                            <asp:SqlDataSource ID="dsDebtors" runat="server" ConnectionString="<%$ ConnectionStrings:conSM %>" SelectCommand="select s.particulars,td.trans_amount,td.trans_id from transDetails td join purchase s 
on
td.trans_id = s.trans_id where td.trans_type = 'purchase' and s.purchase_type = 'Credit'"></asp:SqlDataSource>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                </div>
