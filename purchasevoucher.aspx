<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="purchasevoucher.aspx.cs" Inherits="purchasevoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageWrapper" Runat="Server">
    <div id="page-wrapper">
       <form id="Form1" role="form" runat="server">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Purchase Voucher</h1>
                    ...
                    <div class="form-group">
                        ...
                        <asp:Button runat="server" ID="btnsavePurchase" OnClick="btnsavePurchase_Click"  text="SAVE" CssClass="btn btn-default"/>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <asp:SqlDataSource ID="dsSalesVoucher" runat="server" ConnectionString="<%$ ConnectionStrings:conSM %>" SelectCommand="SELECT s.item_name AS ITEM, ts.qty, ts.amount, ts.rate, ts.vatp, ts.vatamt, ts.extra, ts.discount, ts.total FROM tempPurchase AS ts INNER JOIN stock AS s ON ts.stock_id = s.stock_id"></asp:SqlDataSource>
