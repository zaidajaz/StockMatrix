<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.master" AutoEventWireup="true" CodeFile="purchase.aspx.cs" Inherits="purchase" %>
                        ...
                        <div class="panel-body">
                            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox id="txtsaleQty" runat="server" CssClass="form-control" onchange="reCalc();"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label>Rate</label>
                                        ...
                                        <asp:Button ID="btnAnotherItem" OnClick="btnAnotherItem_Click" runat="server" CssClass="btn btn-default" Text="Add Item" />
                                        <asp:Button ID="btnShowBill" runat="server" Cssclass="btn btn-default"  Text="Show bill" PostBackUrl="purchasevoucher.aspx"/>
